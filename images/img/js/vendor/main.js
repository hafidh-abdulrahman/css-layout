  ...
  "Cw/M": function (e, t) {
    ...
    function a(e, t, n, r) {
      if ((t.hide(), n.hide(), "" !== r.department)) {
        ...
        t.show(),
          "" !== r.location
            ? t.find(`[data-location=${r.location}]`).show()
            : t.find(".positions__single").show();
      } else {
        let t = n;
      ...
      addResizeEvent(s), c(), $(window).scroll(c);
    }
    function s() {
      ...
      n <= 870 &&
        ...
        (e.find(".office").addClass("fade-elements__visible"),
        e.slick({
          speed: 300,
          dots: !0,
          variableWidth: !0,
    ...
    function c() {
      ...
      e > o
        ? i.hasClass("is-sticky") || i.addClass("is-sticky")
        : e <= o && i.hasClass("is-sticky") && i.removeClass("is-sticky");
    }
    $(() => {
      !(function () {
        const e = [],
          ...
          if ($(e).length) {
            const r = $(e),
              i = new Instafeed({
                ...
                get: "user",
                accessToken:
                  "1452900581.1677ed0.fb7a282882b04c1090bb2135a0f3f7a8",
                userId: 1452900581,
                limit: t,
                resolution: "standard_resolution",
                template:
                  '<div><img src="{{image}}" class="img-responsive"/></div>',
                sortBy: "most-recent",
                after() {
                  var e;
                  (e = $(".photos-slider")),
            ...
            e.preventDefault(),
              ...
              $("body").hasClass("is-menu") &&
                $("html").click(function (e) {
                  0 == $(e.target).closest(".main-header__nav").length &&
                    ($("body").removeClass("is-menu"), $(this).unbind(e));
                });
          }),
          (function (e, t, n, r) {
        ...
        $(".filter-select").length &&
          r.find(".filter-select select").on("change", function () {
            const e = $(this),
              t = e.val(),
              n = e.data("sort");
            (u[n] = t), a(r, c, l, u);
        ...
        $(".search__item").length &&
          o.find("[data-country]").on("click", function () {
  ...
  oCYn: function (e, t, n) {
    ...
    (function (e, n) {
          ...
          Object.defineProperty(e, t, {
            ...
            set: function (t) {
              ...
              t === r ||
                (t != t && r != r) ||
                (s && !c) ||
                (c ? c.call(e, t) : (n = t), (l = !i && xe(t)), o.notify());
            },
          });
        }
      }
        ...
        if (void 0 === a) {
          a = (function (e, t, n) {
            ...
            if (
              ...
              return e._props[n];
            return "function" == typeof r && "Function" !== Pe(t.type)
              ? r.call(e)
              : r;
          })(r, i, e);
          var l = $e;
                ...
                i((l = t[c])) ||
                  ...
                  Array.isArray(l)
                    ? l.length > 0 &&
                      (ct((l = e(l, (n || "") + "_" + c))[0]) &&
                        ct(f) &&
                        ((r[u] = me(f.text + l[0].text)), l.shift()),
                      r.push.apply(r, l))
                    : s(l)
                    ? ct(f)
                      ? (r[u] = me(f.text + l))
      ...
      function Pt(e, t, n) {
        var r = !ne();
        "function" == typeof n
          ? ((It.get = r ? Ft(t) : Rt(n)), (It.set = L))
          : ((It.get = n.get ? (r && !1 !== n.cache ? Ft(t) : Rt(n.get)) : L),
            (It.set = n.set || L)),
          ...
          prepatch: function (e, t) {
            ...
            !(function (e, t, n, i, o) {
              ...
              if (
                ...
                we(!1);
                for (
                  var s = e._props, c = e.$options._propKeys || [], l = 0;
                  l < c.length;
                  l++
                ) {
                  var u = c[l],
        ...
        if (!i(e)) {
          ...
          if ((c(e) && (e = u.extend(e)), "function" == typeof e)) {
            ...
            return new pe(
              ...
              void 0,
              n,
              { Ctor: e, propsData: d, listeners: p, tag: l, children: s },
              f
            );
          }
        }
          ...
          (function (e, t, n, r, s) {
            ...
            if ("string" == typeof t) {
              ...
              (u = (e.$vnode && e.$vnode.ns) || B.getTagNamespace(t)),
                (l = B.isReservedTag(t)
                  ? new pe(B.parsePlatformTagName(t), n, r, void 0, void 0, e)
                  : (n && n.pre) || !o((f = Me(e.$options, "components", t)))
            ...
            for (n in c)
              (r = s[n]),
                ...
                r
                  ...
                  : (tr(i, "bind", t, e), i.def && i.def.inserted && l.push(i));
            if (l.length) {
              var f = function () {
      ...
      function rr(e, t) {
        ...
        if (
          ...
          var r,
            ...
            c = e.data.attrs || {},
            l = t.data.attrs || {};
          for (r in (o(l.__ob__) && (l = t.data.attrs = O({}, l)), l))
            (a = l[r]), c[r] !== a && ir(s, r, a);
          for (r in ((J || Y) && l.value !== c.value && ir(s, "value", l.value),
          c))
            i(l[r]) &&
              (Tn(r)
                ? s.removeAttributeNS(Sn, On(r))
      ...
      function Hr(e, t) {
        if (!i(e.data.domProps) || !i(t.data.domProps)) {
          var n,
            ...
            s = e.data.domProps || {},
            c = t.data.domProps || {};
          for (n in (o(c.__ob__) && (c = t.data.domProps = O({}, c)), s))
            i(c[n]) && (a[n] = "");
          for (n in c) {
      ...
      si &&
        (void 0 === window.ontransitionend &&
          ...
          ((ui = "WebkitTransition"), (fi = "webkitTransitionEnd")),
        void 0 === window.onanimationend &&
          void 0 !== window.onwebkitanimationend &&
          ((di = "WebkitAnimation"), (pi = "webkitAnimationEnd")));
      var vi = G
      ...
      function bi(e, t) {
        ...
        return (
          t === ci
            ? a > 0 && ((n = ci), (u = a), (f = o.length))
            : t === li
            ? l > 0 && ((n = li), (u = l), (f = c.length))
            : (f = (n = (u = Math.max(a, l)) > 0 ? (a > l ? ci : li) : null)
                ? n === ci
                  ? o.length
                  : c.length
                : 0),
          ...
          if (!S || $ || "" === $) {
            ...
            var P = !1 !== a && !X,
              ...
              R = (n._enterCb = D(function () {
                P && (yi(n, E), yi(n, O)),
                  R.cancelled ? (P && yi(n, T), N && N(n)) : I && I(n),
                  (n._enterCb = null);
              }));
            e.data.show ||
              ...
              P &&
                ...
                hi(function () {
                  yi(n, T),
                    R.cancelled ||
                      (mi(n, E), F || (ki(M) ? setTimeout(R, M) : gi(n, s, R)));
                })),
        ...
        if (!o(n._leaveCb)) {
          ...
          var w = (n._leaveCb = D(function () {
            n.parentNode &&
              ...
              _ && (yi(n, u), yi(n, f)),
              w.cancelled ? (_ && yi(n, l), m && m(n)) : (t(), h && h(n)),
              (n._leaveCb = null);
          }));
          y ? y(C) : C();
        }
          ...
          w.cancelled ||
            ...
            _ &&
              ...
              hi(function () {
                yi(n, l),
                  w.cancelled ||
                    (mi(n, u), b || (ki($) ? setTimeout(w, $) : gi(n, s, w)));
              })),
            p && p(n, w),
            _ || b || w());
        }
                      ...
                      for (
                        ...
                        i(h)
                          ...
                          : (i(s) && (s = Jn(t, d, v)),
                            ...
                            (g = n[++p]));
                      d > v
                        ? _(e, i(n[y + 1]) ? null : n[y + 1].elm, n, p, y, r)
                        : p > y && $(0, t, d, v);
                    })(d, h, y, n, u)
                  : o(y)
            ...
            if (i(e)) (u = !0), f(t, d);
              ...
              if (!p && Kn(e, t)) x(e, t, d, null, null, s);
                ...
                var v = e.elm,
                  h = l.parentNode(v);
                if (
                  (f(t, d, v._leaveCb ? null : h, l.nextSibling(v)),
                  o(t.parent))
                )
      ...
      function Li(e, t, n) {
        ...
        if (!i || Array.isArray(r)) {
          for (var o, a, s = 0, c = e.options.length; s < c; s++)
            if (((a = e.options[s]), i))
              (o = M(r, Ii(a)) > -1), a.selected !== o && (a.selected = o);
            else if (N(Ii(a), r))
              ...
              J &&
                ...
                (o = (function (e) {
                  for (var t = [], n = 0; n < e.length; n++) {
                    var r = e[n];
                    Jo.test(r.name) ||
                      ((r.name = r.name.replace(Xo, "")), t.push(r));
                  }
                  return t;
                })(o));
              var f,
            ...
            if (((r = i = c[t].name), (o = c[t].value), No.test(r)))
              if (
                ...
                (r = r.replace(Ro, "")),
                  ...
                  s || (!e.component && Lo(e.tag, e.attrsMap.type, r))
                    ? br(e, r, o)
                    : $r(e, r, o);
        ...
        no,
        {
          preTransformNode: function (e, t) {
            if ("input" === e.tag) {
              ...
              if (!r["v-model"]) return;
              if (
                ((r[":type"] || r["v-bind:type"]) && (n = kr(e, "type")),
                r.type ||
                  n ||
                  !r["v-bind"] ||
                  (n = "(" + r["v-bind"] + ").type"),
  ...
  qr4S: function (e, t, n) {
    ...
    var r = n("oCYn"),
      i = function () {
        ...
        return n(
          "div",
          { ref: "videoWrapper", staticClass: "video__wrapper" },
          [
    ...
    var o = (function (e, t, n, r, i, o, a, s) {
    ...
    })(
      {
        ...
        data: () => ({
          ...
          poster:
            "//s3-eu-west-1.amazonaws.com/docplanner.com/video/background.png",
          choice: null,
          srcList: null,
          currentScene: null,
          ext: null,
        ...
        methods: {
          ...
          setChoice(e) {
            (this.activateChoices = !1),
              ...
              (this.choiceMade = e);
            ["scene19", "scene20", "scene21", "scene22"].indexOf(
              this.scene.choice1
            ) > -1
              ? ((this.lastScene = !0),
                ...
                setTimeout(() => {
                  "left" === e
                    ? (this.src = this.choice1)
                    : "right" === e && (this.src = this.choice2);
                }, 3e3))
              : (this.setNextSceneData(e),
                setTimeout(() => {
                  "left" === e
                    ? (this.src = this.srcsBuffered[0])
                    : "right" === e && (this.src = this.srcsBuffered[1]);
                }, 3e3));
          },
          prepareSrcList(e) {
            this.srcList = e;
          ...
          prepareFile(e, t) {
            ...
            return new Promise(function (e, t) {
              ...
              !0 === n.initial
                ? (o =
                    "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" +
                    n.fileSize +
                    "/" +
                    r +
                    "." +
                    n.ext)
                : "choice1" === i
                ? null !== n.srcList[n.scene.choice1].src &&
                  (o =
                    "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" +
                    n.fileSize +
                    "/" +
                    n.srcList[n.scene.choice1].src +
                    "." +
                    n.ext)
                : "choice2" === i
                ? null !== n.srcList[n.scene.choice2].src &&
                  (o =
                    "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" +
                    n.fileSize +
                    "/" +
                    n.srcList[n.scene.choice2].src +
                    "." +
                    n.ext)
                : (o =
                    "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" +
              ...
              ((a = new XMLHttpRequest()).responseType = "blob"),
                ...
                (a.onload = function () {
                  if (200 === a.status) {
                    ...
                    t.onload = function (t) {
                      let r = atob(
                          t.currentTarget.result.slice(
                            t.currentTarget.result.indexOf(",") + 1
                          )
                        ),
            ...
            return new Promise(function (e, t) {
              (n.xhr = new XMLHttpRequest()),
                ...
                (n.xhr.onload = function () {
                  200 === n.xhr.status
                    ? e({ xhrResponse: n.xhr.response, choiceNo: i })
                    : t(
                        Error(
            ...
            return new Promise(function (r, i) {
              !0 === n.isChoiceEnded
                ? "choice1" === t
                  ...
                  : "choice2" === t &&
                    ((n.choice2 = e), (n.srcsBuffered[1] = e), r())
          ...
          endEvent() {
            if (!1 === this.lastScene)
              if (
                (this.isChoice ? (this.isChoice = !1) : (this.isChoice = !0),
                null !== this.currentScene)
              ) {
                let e = this;
                null === e.scene.choice1
                  ? (e.lastScene = !0)
                  : this.prepareFile(this.scene.srcChoice, null).then(function (
                      t
                    ) {
                      t.match(/blob/g)
                        ? ((e.src = t),
                ...
                this.isChoiceEnded
                  ? (this.activateChoices = !0)
                  : this.isChoiceEnded || this.autoload();
            else this.scrollDownButtonActivate = !0;
          },
          autoload() {
            !0 === this.isChoice
              ? this.bufferVideo(this.isChoice)
              : this.bufferVideo();
          },
          getNextSceneUrl(e) {
            let t = this;
          ...
          setNextSceneData(e) {
            ...
            if (void 0 !== e) {
              ...
              null !== this.currentScene
                ? ((t = this.srcList[this.currentScene]),
                  (this.scene = {
                ...
                : !1 === this.isChoice &&
                  ((t = this.srcList["scene" + (this.scene.step + 1)]),
                  (this.scene = {
                    step: this.scene.step + 1,
                    src: t.src,
                    srcChoice: t.srcChoice,
