...
function scrollToY(t, e, i, n) {
  function o() {
    var e = (r += 1 / 60) / a,
      d = l[i](e);
    e < 1
      ? (requestAnimationFrame(o), window.scrollTo(0, s + (t - s) * d))
      : (n && n(), window.scrollTo(0, t));
  }
  ...
  var s = window.scrollY || window.pageYOffset,
    ...
    i = i || "easeOutSine",
    r = 0,
    a = Math.max(0.1, Math.min(Math.abs(s - t) / e, 0.8)),
    l =
      (Math.PI,
      {
...
function prepareTmpl(t, e) {
  var i, n;
  n = e;
  for (i in t) n = n.replace(new RegExp("{{" + i + "}}", "g"), t[i]);
  return n;
}
!(function (t) {
    ...
    function n(e, o, s) {
      ...
      if ("undefined" != typeof document) {
        if (arguments.length > 1) {
          if (
            "number" == typeof (s = t({ path: "/" }, n.defaults, s)).expires
          ) {
            var a = new Date();
        ...
        for (
          ...
          try {
            ...
            if (
              ((h = i.read
                ? i.read(h, p)
                : i(h, p) || h.replace(d, decodeURIComponent)),
              this.json)
            )
              try {
                h = JSON.parse(h);
  ...
  (function (t) {
    ...
    t.fn.counterUp = function (i) {
      var n = t.extend({ time: 400, delay: 10 }, i);
      return this.each(function () {
        ...
        !(function () {
          ...
          for (
            var a = /^[0-9]+\.[0-9]+$/.test(s),
              l = a ? (s.split(".")[1] || []).length : 0,
              d = n;
            d >= 1;
            d--
          ) {
            var c = parseInt((s / n) * d);
            if ((a && (c = parseFloat((s / n) * d).toFixed(l)), r))
...
var isMobile = navigator.userAgent.match(
    /Android|AvantGo|BlackBerry|DoCoMo|Fennec|iPod|iPhone|iPad|J2ME|MIDP|NetFront|Nokia|Opera Mini|Opera Mobi|PalmOS|PalmSource|portalmmm|Plucker|ReqwirelessWeb|SonyEricsson|Symbian|UP\\.Browser|webOS|Windows CE|Windows Phone OS|Xiino/i
  ),
  cssProp = function (t) {
    var e = document.body,
      i = !1,
    ...
    if (!i) {
      for (var a = 0; a < s; a++)
        if (("" == o[a] && (r = r.toLowerCase()), void 0 != n[o[a] + r]))
          return o[a] + r;
      i = !0;
    }
  };
...
var loadScript = function (t) {
    ...
    ((e = document.createElement("script")).type = "text/javascript"),
      (e.src = t),
      (i = document.getElementsByTagName("script")[0]).parentNode.insertBefore(
        e,
        i
      );
  },
...
($jscomp.defineProperty =
    ...
    function (t) {
        ...
        var o = {
          ...
          getRegexMask: function () {
            for (var t, e, n, o, s = [], a = 0; a < i.length; a++)
              (t = r.translation[i.charAt(a)])
                ? ((e = t.pattern.toString().replace(/.{1}$|^.{1}/g, "")),
                  (n = t.optional),
                  (t = t.recursive)
                    ? (s.push(i.charAt(a)),
                      (o = { digit: i.charAt(a), pattern: e }))
                    : s.push(n || t ? e + "?" : e))
                : s.push(i.charAt(a).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
            return (
              (s = s.join("")),
              o &&
                (s = s
          ...
          calculateCaretPosition: function () {
            ...
            if (t !== i) {
              ...
              for (s = n - 1; 0 <= s && o.maskDigitPosMap[s]; s--) t++;
              for (s = n - 1; 0 <= s; s--) o.maskDigitPosMap[s] && d++;
              for (s = r - 1; 0 <= s; s--) o.maskDigitPosMapOld[s] && c++;
              n > a
                ? (n = i)
                : r >= n && r !== a
                ? o.maskDigitPosMapOld[n] ||
                  ((r = n),
                  (n = n - (c - d) - t),
                  o.maskDigitPosMap[n] && (n = r))
                : n > r && (n = n + (d - c) + l);
            }
            return n;
          },
            ...
            for (var w; a(); ) {
              ...
              S
                ? (k.match(S.pattern)
                    ...
                    ? ((c += f), (h -= f))
                    : S.fallback
                    ? (l[m](S.fallback), (c += f), (h -= f))
                    : o.invalid.push({ p: h, v: k, e: S.pattern }),
                  (h += f))
                : (t || l[m](b),
                  k === b
                    ? (y.push(h), (h += f))
          ...
          mapMaskdigitPositions: function (t, e, i) {
            for (
              t = n.reverse ? t.length - i : 0, o.maskDigitPosMap = {}, i = 0;
              i < e.length;
              i++
            )
      ...
      var i = function () {
          var i = t(this),
            ...
            s = i.attr("data-mask");
          if (
            (i.attr("data-mask-reverse") && (o.reverse = !0),
      ...
      (t.fn.mask = function (i, o) {
        ...
        (o = t.jMaskGlobals = t.extend(!0, {}, o, t.jMaskGlobals)).dataMask &&
          t.applyDataMask(),
  ...
  (function (t) {
    ...
    t.extend(t.fn, {
      ...
      rules: function (e, i) {
        ...
        if (e)
          switch (
            ((n = t.data(d.form, "validator").settings),
            (o = n.rules),
          ...
          for (var s in this.waypoints[i]) {
            ...
            if (null !== r.triggerPoint) {
              var a = n.oldScroll < r.triggerPoint,
                ...
                d = a && l,
                c = !a && !l;
              (d || c) && (r.queueTrigger(o), (t[r.group.id] = r.group));
            }
          }
        }
    ...
    return (function () {
      ...
      function o() {
        window.scrollTo(0, r + u),
          s && c && (s.setAttribute("tabindex", "-1"), s.focus()),
          "function" == typeof g && g(),
          (p = !1);
      }
      var s = void 0,
      ...
      return function (o) {
        ...
        switch (
          ...
          case "object":
            ...
            break;
          case "string":
            (s = document.querySelector(o)), (a = i(s));
        }
        switch (((u = a - r + l), t(p.duration))) {
          case "number":
            h = p.duration;
            break;
          case "function":
  ...
  (function (t, e) {
    ...
    function o(o) {
      if (
        ...
        for (
          var c = (d.isBorderBox = "border-box" == r.boxSizing), u = 0;
          l > u;
          u++
        ) {
          var h = a[u],
  ...
  (function (t, e, i) {
    ...
    var o,
      ...
      N = function () {
        var e =
            ...
            t[W.toLowerCase() + "RequestAnimationFrame"],
          i = zt();
        return (
          (_t || !e) &&
            (e = function (e) {
      ...
      B = function () {
        var e =
          t.cancelAnimationFrame || t[W.toLowerCase() + "CancelAnimationFrame"];
        return (
          (_t || !e) &&
            (e = function (e) {
    ...
    (n.prototype.refresh = function (t) {
      ...
      for (
        t === i
          ? ((s = !0), (st = []), (Wt = 0), (t = e.getElementsByTagName("*")))
          : t.length === i && (t = [t]),
          n = 0,
          o = t.length;
        o > n;
        ...
        var r = t[n],
          ...
          c = gt,
          u = !1;
        if ((s && $ in r && delete r[$], r.attributes)) {
                    ...
                    if (null !== g) {
                      ...
                      b && "start" !== b && "end" !== b
                        ...
                        : ((v.mode = "absolute"),
                          "end" === b
                            ? (v.isEnd = !0)
                            : v.isPercentage || (v.offset = v.offset * Ot));
                    }
                  } else u = !0;
                else c = m.value;
              else d = "off" !== m.value;
          ...
          if (l.length) {
            var S, T, x;
            !s && $ in r
              ? ((x = r[$]), (S = st[x].styleAttr), (T = st[x].classAttr))
              : ((x = r[$] = Wt++), (S = r.style.cssText), (T = At(r))),
              (st[x] = {
                element: r,
                styleAttr: S,
                classAttr: T,
      ...
      (n.prototype.animateTo = function (t, e) {
        ...
        return (
          ...
          }).topDiff || (ut.done && ut.done.call(ot, !1), (ut = i)),
          ot
        );
      }),
      (n.prototype.stopAnimateTo = function () {
        ut && ut.done && ut.done.call(ot, !0), (ut = i);
      }),
      ...
      (n.prototype.off = function (t) {
        return delete at[t], ot;
      }),
      (n.prototype.destroy = function () {
        B()(yt), kt(), Et(o, [w], [y, b, k]);
    ...
    var U = function () {
        ...
        for (d = 0, c = st.length; c > d; d++)
          for (
            ...
            (a = n[s]),
              ...
              (h = f[a.constant] || 0),
              (a.frame = u),
              a.isPercentage && ((u *= p), (a.frame = u)),
              "relative" === a.mode &&
                (it(e),
                (a.frame =
                  ot.relativeToAbsolute(i, a.anchors[0], a.anchors[1]) - u),
                it(e, !0)),
              (a.frame += h),
              lt && !a.isEnd && a.frame > Mt && (Mt = a.frame);
        for (Mt = l.max(Mt, Ct()), d = 0, c = st.length; c > d; d++) {
          for (s = 0, r = (n = (t = st[d]).keyFrames).length; r > s; s++)
            (a = n[s]),
              (h = f[a.constant] || 0),
            ...
            switch (
              (w
                ? (Et(d, [m], [v, g]),
                  S &&
                    T > -1 &&
                    (St(d, p.eventType, It), (l.lastFrameIndex = -1)))
                : (Et(d, [v], [m, g]),
                  S &&
                    h > T &&
                    (St(d, y.eventType, It), (l.lastFrameIndex = h))),
              (l.edge = w ? -1 : 1),
              l.edgeStrategy)
            ) {
              case "reset":
              ...
              case "set":
                ...
                for (o in x)
                  a.call(x, o) &&
                    ((s = et(x[o].value)),
                    0 === o.indexOf("@")
                      ? d.setAttribute(o.substr(1), s)
                      : r.setStyle(d, o, s));
                continue;
            }
          } else 0 !== l.edge && (Et(d, [f, g], [m, v]), (l.edge = 0));
          for (var C = 0; h - 1 > C; C++)
      ...
      Q = function () {
        ...
        if (
          (ut
            ? (o >= ut.endTime
                ? ((n = ut.targetTop), (t = ut.done), (ut = i))
                : ((e = ut.easing((o - ut.startTime) / ut.duration)),
          ...
          !1 !== (at.beforerender && at.beforerender.call(ot, s)) &&
            (Y(n, ot.getScrollTop()),
            _t &&
              rt &&
              r.setStyle(rt, "transform", "translate(0, " + -qt + "px) " + vt),
            (Lt = n),
      ...
      X = function (t) {
        for (var e = 0, i = t.keyFrames.length; i > e; e++) {
          for (
            var n, o, s, r, a = t.keyFrames[e], l = {};
            null !== (r = M.exec(a.props));

          )
            (s = r[1]),
              (o = r[2]),
              null !== (n = s.match(O)) ? ((s = n[1]), (n = n[2])) : (n = S),
              (o = o.indexOf("!") ? Z(o) : [o.slice(1)]),
              (l[s] = { value: o, easing: V[n] });
          a.props = l;
        }
      },
      Z = function (t) {
      ...
      K = function (t) {
        ...
        for (n = {}, e = t.keyFrames.length - 1; e >= 0; e--)
          J(t.keyFrames[e], n);
      },
      J = function (t, e) {
        var i;
      ...
      nt = function () {
        (vt = "translateZ(0)"), r.setStyle(rt, "transform", vt);
        var t = d(rt),
    ...
    var ot,
      ...
      Tt = function () {
        ...
        (Mt = 0),
          ...
          _t
            ? ot.setScrollTop(l.min(ot.getScrollTop(), Mt))
            : ot.setScrollTop(t, !0),
          (mt = !0);
      },
      xt = function () {
        var t,
          ...
          n = {};
        for (t in dt)
          "function" == typeof (e = dt[t])
            ? (e = e.call(ot))
            : /p$/.test(e) && (e = (e.slice(0, -1) / 100) * i),
            (n[t] = e);
        return n;
      },
      Ct = function () {
        var t = 0;
        return (
          rt && (t = l.max(rt.offsetHeight, rt.scrollHeight)),
          l.max(
            t,
            s.scrollHeight,
            s.offsetHeight,
  ...
  (function () {
    ...
    (t.prototype.TYPES = [
      ...
      (t.prototype.scan = function (t) {
        for (
          var e, i, n, o, s = t.querySelectorAll(this.TYPES.join(",")), r = 0;
          r < s.length;
          r++
        )
          (i = s[r]),
    ...
    (e.LINEAR = function (t) {
                ...
                if (!o.isReady) {
                  ...
                  return o.el
                    ? (t.getAttribute("built-by-vivus") &&
                        (o.parentEl.insertBefore(o.el, t),
      ...
      (e.prototype.setOptions = function (t) {
        ...
        if (
          ((this.type = t.type || i[0]), t.start && -1 === n.indexOf(t.start))
        )
          throw new Error(
            "Vivus [constructor]: " +
              t.start +
      ...
      (e.prototype.mapping = function () {
        ...
        for (
          ...
          (i = e[t]),
            this.isInvisible(i) ||
              ((o = { el: i, length: Math.ceil(i.getTotalLength()) }),
              isNaN(o.length)
                ? window.console && console.warn
                : (this.map.push(o),
                  (i.style.strokeDasharray =
                    o.length + " " + (o.length + 2 * this.dashGap)),
